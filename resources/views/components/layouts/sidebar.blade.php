                ...
                <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-wira-dark-700">
                    ...
                    <li>
                        <a href="{{ route('users.index') }}"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-wira-dark-700 group {{ request()->routeIs('users.*') ? 'bg-gray-100 dark:bg-wira-dark-700' : '' }}"
                            wire:navigate>
                            <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
